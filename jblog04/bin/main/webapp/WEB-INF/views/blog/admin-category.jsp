		...
		<div id="wrapper">
			<div id="content" class="full-screen">
				<ul class="admin-menu">
		      	...
		      	<table class="admin-cat">
					...
					<c:forEach items="${category }" var="vo" varStatus="status">
						<tr>
							...
							<td>
								<a href="${pageContext.request.contextPath}/${blog.blogId }/admin/category/delete/${vo.no}">
      			...
      			<form method="post" action="${pageContext.request.contextPath }/${blog.blogId}/admin/category">
